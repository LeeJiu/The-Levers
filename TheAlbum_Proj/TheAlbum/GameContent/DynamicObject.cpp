...
//ｰﾔﾀﾓ ｳｻ ｿﾀｺ�ﾁｧﾆｮ ﾁﾟｿ｡ ｿﾌｴﾂ ｰﾍｵ鯊ｻ ﾁ､ﾀﾇ.
namespace {
...
//できるだけ不正くさい値を入れておく。setが呼ばれないと?ぬように。
...
void DynamicObject::draw( const Image* image ) const {
	...
	image->draw( dstX * 2, dstY * 2, srcX, srcY, 32, 32 ); //解像度が?になったのでここで位置を?に
}
